...
def toxml(dict, xml_path):
    ...
    for i in range(len(dict)):
        if dict["shape"+str(i)][0] == 'rectangle':
            content_list_xml.append('<mxCell id="'+'shape'+str(i)+'" value="" style="whiteSpace=wrap;html=1;aspect=fixed;" vertex="1" parent="1"><mxGeometry x="'+str(int(dict["shape"+str(i)][1][0]))+'" y="'+str(int(dict["shape"+str(i)][1][1]))+'" width="'+str(int(dict["shape"+str(i)][1][2]))+'" height="'+str(int(dict["shape"+str(i)][1][3]))+'" as="geometry" /></mxCell>')
        elif dict["shape"+str(i)][0] == 'circle':
            content_list_xml.append('<mxCell id="'+'shape'+str(i)+'" value="" style="ellipse;whiteSpace=wrap;html=1;" vertex="1" parent="1"><mxGeometry x="'+str(int(dict["shape"+str(i)][1][0]))+'" y="'+str(int(dict["shape"+str(i)][1][1]))+'" width="'+str(int(dict["shape"+str(i)][1][2]))+'" height="'+str(int(dict["shape"+str(i)][1][3]))+'" as="geometry" /></mxCell>')
        elif dict["shape"+str(i)][0] == 'triangle':
            content_list_xml.append('<mxCell id="'+'shape'+str(i)+'" value="" style="triangle;whiteSpace=wrap;html=1;rotation=-90;" vertex="1" parent="1"><mxGeometry x="'+str(int(dict["shape"+str(i)][1][0]))+'" y="'+str(int(dict["shape"+str(i)][1][1]))+'" width="'+str(int(dict["shape"+str(i)][1][2]))+'" height="'+str(int(dict["shape"+str(i)][1][3]))+'" as="geometry" /></mxCell>')
        else:
            pass
